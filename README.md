...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/h5io_browser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/h5io_browser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add h5io_browser
# for installing globally
pixi global install h5io_browser
```
...
It is possible to list all of the versions of `h5io_browser` available on your platform:
...
```
pixi search h5io_browser --channel conda-forge
```
